#FROM https://community.plotly.com/t/slider-with-play-button-for-animations-independent-of-plotly/53188/7

# package imports
from dash_extensions.enrich import html, dcc, Output, Input, State, callback, MATCH
...
class PlaybackSliderAIO(html.Div):
    ...
    @callback(
        ...
        State(ids.slider(MATCH), 'drag_value')
    )
